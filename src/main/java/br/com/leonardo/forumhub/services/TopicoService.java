package br.com.leonardo.forumhub.services;

import br.com.leonardo.forumhub.domain.curso.Curso;
import br.com.leonardo.forumhub.domain.topico.*;
import br.com.leonardo.forumhub.domain.usuario.Usuario;
import br.com.leonardo.forumhub.repositories.CursoRepository;
import br.com.leonardo.forumhub.repositories.TopicosRepository;
import br.com.leonardo.forumhub.repositories.UsuarioRepository;
...
public class TopicoService {
    ...
    @Transactional
    public DetalhamentoDadosTopico atualizar(AtualizacaoDadosTopico dados, Long id) {
        validarDuplicidade(dados.titulo(), dados.mensagem());
